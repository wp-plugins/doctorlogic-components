...
Plugin URI: https://doctorlogic.com/wordpress/doctorlogic-components.zip
...
function dl_styles() {
	wp_enqueue_style( 'dl-layout', plugins_url() . "/doctorlogic-components/css/layout.css");
    wp_enqueue_style( 'dl-palette', plugins_url() . "/doctorlogic-components/css/palette.css");
    wp_enqueue_style ('dashicons');
	wp_enqueue_script( 'jquery');
	wp_enqueue_script( 'dl-script', plugins_url() . "/doctorlogic-components/scripts/scripts.js");
}
